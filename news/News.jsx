      ...
      <section id="News__section">
        ...
        <main className="News__main">
          <div className="News__main-wrap">
            {news.map((news_data, index) => {
              return (
                <div key={news_data.news_id} classMame="News__img-id-wrap">
                  <Link to={`/news/${news_data.news_id}`}>
                    <img className="News__card-img-top" src={news_data.img_file} />
                    <h4 className="News__newsId ">{news_data.name}</h4>
                    <p className="News__article">
                      <BiTimeFive />
                      {news_data.news_time}
                    </p>
                    <p className="News__text">{news_data.news_introduction}</p>
                  </Link>
                </div>
              )
            })}
