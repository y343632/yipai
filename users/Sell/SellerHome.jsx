        ...
        <>
            <div className='d-flex'>
                ...
                <table>
                  <tr>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-red"></div>
                    </td>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-ori"></div>
                    </td> 
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-yel"></div>
                    </td>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-gre"></div>
                    </td>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-blu"></div>
                    </td>
        
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-pur"></div></td>
                  </tr>
                  <tr>

                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-bro"></div>
                    </td>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-whi" ></div>
                    </td>
                

                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-gra" ></div>
                    </td>
                    <td>
                      <div className="SellerUpload__color-item SellerUpload__color-item-bla"></div>
                    </td> 
                  </tr>
                </table>
                            ...
                            <Button variant="dark" onClick={handleProductSubmit}>儲存並送出</Button>
                        </div>
                    </div>
